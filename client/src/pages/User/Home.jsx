    ...
    try {
        return (
            <div data-name="home-page" className="relative">
                ...
                <section data-name="hero-section" className="hero-section h-[500px] flex items-center justify-center text-white relative overflow-hidden">
                    {/* Image carousel */}
                    ...
                    <div className="text-center relative z-20">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg w-[200px] text-center cursor-pointer hover:bg-blue-600 hover:text-white transition duration-300">
                            ...
                            <Link to="/request-tour">
                                <div className="bg-white p-6 rounded-lg shadow-lg w-[200px] text-center cursor-pointer hover:bg-blue-600 hover:text-white transition duration-300">
                                    <h3 className="text-xl font-semibold mb-2 text-gray-800 hover:text-white">Request a Tour</h3>
                                    <p className="text-gray-600 hover:text-white">Share your preferences</p>
                                </div>
                            </Link>
                        </div>
                    </div>
                ...
                <section data-name="popular-tours" className="py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <div className="text-center mt-10">
                            <Link to="/user/tours" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
                                View All Tours
                            </Link>
                        </div>
                    </div>
