...
export default function Home() {
  ...
  const heroImages = [
    "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1530521954074-e64f6810b32d?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1498307833015-e7b400441eb8?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
    "https://images.unsplash.com/photo-1488085061387-422e29b40080?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80",
  ];
  ...
  const handleCustomizePackageClick = () => {
    const token = localStorage.getItem("token");
    if (token) {
      navigate("/customized-packages");
    } else {
  ...
  try {
    return (
      <>
          ...
          >
            ...
            <div className="text-center relative z-20">
              ...
              <p className="text-xl mb-8">
                Experience the world with our expertly curated tours
              </p>
              ...
              <div className="flex justify-center gap-8">
                <div
                  onClick={handleCustomizePackageClick}
                ...
                >
                  <h3 className="text-xl font-semibold mb-2 text-gray-800 hover:text-white">
                    Customized Packages
                  </h3>
                ...
                <Link to="/user/tours/:id">
                  <div className="bg-white p-6 rounded-lg shadow-lg w-[200px] text-center cursor-pointer hover:bg-blue-600 hover:text-white transition duration-300">
                    <h3 className="text-xl font-semibold mb-2 text-gray-800 hover:text-white">
                      Our Packages
                    </h3>
                    <p className="text-gray-600 hover:text-white">
                      Explore our special deals
                    </p>
                  </div>
                </Link>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Professional and knowledgeable guides for your journey
                  </p>
                </div>
                <div className="text-center">
                  <svg
                  ...
                  <p className="text-gray-600">
                    Carefully selected hotels for your comfort
                  </p>
                </div>
                <div className="text-center">
                  <svg
                  ...
                  <p className="text-gray-600">
                    Tours that fit your timeline and preferences
                  </p>
                </div>
              </div>
            </div>
        ...
        {showLoginAlert && (
          <div className="absolute top-[50px] w-full flex justify-center z-50">
            <div className="bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg animate-bounce">
              Please log in to access Customized Packages!
            </div>
          </div>
        )}
      </>
